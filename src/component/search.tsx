...
export default function Search() {
    ...
    return (
        <div className="space-x-2 mt-2 md:mt-0 mb-2 md:mb-0">
            <input className="bg-gray-600 border border-white/80 rounded-lg px-2 py-1" type="text" placeholder="search for anime" onChange={handleChange} onKeyDown={hadlekeydown}/>
