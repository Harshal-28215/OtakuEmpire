...
export default function Page() {
  return (
    <main className='flex p-5 justify-between bg-gray-600 text-white w-[100%] h-[calc(100vh-50px)] md:mt-[50px] z-20 md:flex-row flex-col-reverse overflow-hidden relative'>
